...
# Headers
proc delay(sn: float): bool
proc exit(): bool
proc logger(var_type: string; this: string): bool
proc namecorrection(name: string): bool
proc plugins(var_type: string; arg: string): string
proc rand(var_type: bool): int
